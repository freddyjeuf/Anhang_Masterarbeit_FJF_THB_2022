/*******************************************************************************
   ...
   Edited by Freddy Jeufack Fotsop, 2022
...
//-------------------------TTN Device ID: id-id-id-id-id (RevB) 12.07.22---------------------
...
const unsigned TX_INTERVAL = 150;  //>=150s when permanently on. (Avg. TX Airtime = 52ms = 0,052s)
...
void do_send(osjob_t* j) {
  ...
  if (LMIC.opmode & OP_TXRXPEND) {
    ...
    uint32_t humidity = dht.readHumidity(false) * 10;
    uint32_t temperature = dht.readTemperature(false) * 10;
    ...
    /*
    Serial.print("Humidity word: ");
    Serial.print(payload[0], BIN);
    Serial.println(payload[1], BIN);
    Serial.print("Temperature word: ");
